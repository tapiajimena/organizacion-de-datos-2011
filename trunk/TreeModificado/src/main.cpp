...
void testFind()
{
	...
	cout<<"OFFSET 1er LIBRO: "<<elementoRecuperado->getLibros().back()<<endl;
...
int main()
{
	BPlusTree* tree = new BPlusTree("indArbol.dat", BLOCKSIZE);

	DatoElementoNodo* elemento  = new DatoElementoNodo("a", 12);
	DatoElementoNodo* elemento1 = new DatoElementoNodo("a", 18);
	DatoElementoNodo* elemento2 = new DatoElementoNodo("d", 31);
	DatoElementoNodo* elemento3 = new DatoElementoNodo("g", 61);
	DatoElementoNodo* elemento4 = new DatoElementoNodo("h", 71);
	DatoElementoNodo* elementoRecuperado = new DatoElementoNodo("", 0);
	DatoElementoNodo* elementoRecuperado2 = new DatoElementoNodo("", 0);
	...
	*/
	...
	elementoRecuperado = tree->find(elemento);
